...
#CACHE_MIDDLEWARE_KEY_PREFIX = 'sitemon_'
...
SITE_MAIN_MENU = [
    ...
    {'code' : 'ind', 'name' : u'Индикаторы', 'url' : '/indicators/'},
    {'code' : 'about', 'name' : u'О проекте', 'url' : '/about/', 'last' : True},
]
        
DEFAULT_FROM_EMAIL = 'support'
EMAIL_HOST ='smtp.gmail.com'
EMAIL_HOST_USER = 'support@dplabs.ru'
EMAIL_HOST_PASSWORD = ''
EMAIL_USE_TLS=True
EMAIL_PORT=587
